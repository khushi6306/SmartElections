...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        resized_img = cv2.resize(crop_img, (60, 60)).flatten().reshape(1,-1)
    ...
    frame_resized = cv2.resize(frame, (640, 114))
    imgBackground[370:370+480,225:225+640]=frame_resized  
    ...
    if k==ord('1'):
        ...
        if exist:
            ...
            csvfile.close()    
            speak("THANK YOU FOR PARTICIPATING IN TH ELECTIONS")
            break
    if k==ord('2'):
        speak("YOUR VOTE HAS BEEN RECORDED")
        time.sleep(3)
